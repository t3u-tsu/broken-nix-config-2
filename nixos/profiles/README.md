...
- **`desktop/`**: Desktop experience — Niri, PipeWire, NetworkManager, GUI apps; aggregates the desktop stack via `my.services.desktop.enable` / `my.home.desktop.enable` and wires `home/desktop` into Home Manager for the primary user.
